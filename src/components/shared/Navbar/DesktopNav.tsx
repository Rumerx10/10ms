...
// If you were using local images, you would import them like this:
// import logo from '../public/images/svg/10mslogo-svg.svg';
// import facebookIcon from '../public/images/facebook_1695730910971.png';
// etc.
    ...
    <div className='fixed z-50 left-0 -top-1 md:top-0 right-0 h-16 flex w-full items-center justify-center'>
      <div className="flex max-w-[1440px] w-full bg-white items-center justify-between gap-3 px-4 py-3 md:px-7">
        <div className="flex gap-2">
          ...
          <button className="xl:hidden" type="button" name="menu-toggle" aria-label="menu-toggle">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
          ...
          {/* Mobile logo (hidden on desktop, but present in original HTML) */}
          <div className="md:hidden h-[27px] w-[100px]">
            <LogoSvg />
          </div>
        </div>

        {/* Desktop logo */}
        <div className="items-center hidden h-[27px] w-[100px] gap-9 md:flex">
          <LogoSvg />
        </div>

        {/* Search Bar (hidden on mobile) */}
        <div className="flex-1 hidden w-[204px] pr-4 md:block">
            ...
            <div className="relative flex w-full flex-col items-center bg-white z-50">
              <div className="shadow-0 rounded-b-[23px] flex w-full items-center gap-2 rounded-t-[23px] border-0 px-[12px] py-2 md:border">
                ...
                <input
                  ...
                  className="w-full flex-1 placeholder:text-sm placeholder:font-normal placeholder:leading-4 placeholder:text-[#7C818A] focus:outline-none"
                  name="Search"
                  defaultValue=""
                />
              </div>
        ...
        <nav className="hidden mr-4 xl:block">
          <ul className="flex items-center gap-2 lg:gap-4">
            <li className="relative">
              <div aria-label="Customise options" className="cursor-pointer" data-state="closed">
                <div className="text-base">
                  <a
                    className=" flex cursor-pointer items-center justify-center gap-0.5 text-sm font-medium text-[#4B5563] hover:text-green-600"
                    href="/academic/"
                  >
            ...
            <li className="relative">
              <a
                className=" text-[#4B5563] text-sm font-medium hover:text-green-600"
                href="/admission/"
              >
                Admission
              </a>
        ...
        {/* Language, Call, and Login Buttons */}
        <div className="flex items-center space-x-4 md:space-x-6">
          <div className="flex items-center gap-3 rounded-md max-h-96 md:gap-6">
            ...
            <a className="items-center hidden gap-1 text-green-600 md:flex" href="tel:16910">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
          ...
          <div className="block">
            ...
            >
              <span
                id="login-button"
                className="leading-[18px] whitespace-nowrap text-[12px] font-semibold leading-[24px] md:text-[16px] md:font-medium"
              >
                লগ-ইন
              </span>
            </a>
