...
const Navbar = () => {
  return (
    <div className="fixed z-50 bg-white left-0 -top-1 md:top-0 right-0 h-18 flex w-full items-center justify-center">
        ...
        <div className="flex items-center space-x-4 md:space-x-6">
          ...
          <div className="block">
            ...
            >
              <span
                id="login-button"
                className="leading-[18px] whitespace-nowrap text-[12px] font-semibold lg:leading-[24px] md:text-[16px] md:font-medium"
              >
                লগ-ইন
              </span>
            </a>
